...
This repository contains raw data for the [PGLearn Midwest24k dataset](https://huggingface.co/datasets/PGLearn/PGLearn-ExtraLarge-Midwest24k).
...
The original Matpower and time series data files are part of the [Texas A&M University Electric Grid Datasets](https://electricgrids.engr.tamu.edu/),
    namely the [23,643-bus Midwest synthetic grid](https://electricgrids.engr.tamu.edu/texas-am-perform-cases/).
